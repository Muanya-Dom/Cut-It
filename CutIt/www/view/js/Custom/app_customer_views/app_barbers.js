...
$.ajax({
    url: 'https://cutit01.000webhostapp.com/view/api/api_customer_barbers.php',
    datatype:'json',
...
function send(event)
{
    ...
    $.ajax({
        url:'https://cutit01.000webhostapp.com/view/api/api_customer_barber_details.php',
        dataType: 'json',
        type:'POST',
...
$(document).ready(function() {
    ...
    $.ajax({
        url: 'https://cutit01.000webhostapp.com/view/api/api_customer.php',
        datatype:'json',
        success: function (data)
        {
    ...
    $("#location_search").click(function(e) 
    {
        ...
        if(location != "")
        {
            ...
            $.ajax({
                url:'https://cutit01.000webhostapp.com/view/api/api_customer_onclick.php',
                dataType: 'json',
                type:'POST',
