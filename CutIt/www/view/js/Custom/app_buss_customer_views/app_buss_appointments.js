...
$.ajax({
    url: 'https://cutit01.000webhostapp.com/view/api/api_buss_customer_appointments.php',
    datatype:'json',
...
function deleteAppointment(event)
{
    ...
    $.ajax({
        url:'https://cutit01.000webhostapp.com/view/api/api_buss_customer_onclick.php',
        dataType: 'json',
        type:'POST',
